...
vote_data_clean <- vote_data %>% 
  ...
  select(-c(chamber, clerk_rollnumber, yea_count, nay_count, nominate_mid_1, nominate_mid_2, nominate_spread_1, nominate_spread_2, nominate_log_likelihood, bill_number, vote_result, dtl_desc, rollnumber, session)) %>% 
...
ggplot()+
  geom_point(data = trading_volume_by_day, mapping = aes(x = transaction_date, y = n))+
